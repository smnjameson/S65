...
* Asset_ImportSprites("player","assets/bin/sprites1", $8000)<br><br>
...
* When loading using these imports you only need the first part of the path and file name. eg<br><br>
* Asset_ImportChars("map","assets/bin/tileset1", $8000)<br><br>
...
*/
.macro Asset_ImportChars (name, path, address) {
		.if(address / $40 != floor(address/$40)) {
			.eval address = (floor(address/$40) + 1) * $40 
        ...
        * = address
    		...
    		.eval charSet.colors = paletteBin
    		.if(paletteBin.getSize() > 0) {
    			.eval charSet.colorAddress = *
    			.fill paletteBin.getSize(), paletteBin.get(i)
    		}
...
*/
.macro Asset_ImportCharPalette( name ) {
