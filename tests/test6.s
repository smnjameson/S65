...
#import "includes/s65/start.s"
	jmp Start 
		...
		Asset_ImportSprites("player", "assets/bin/t6_sprites1", $8000)
		Asset_ImportSprites("enemy", "assets/bin/t6_sprites2", S65_LastImportPtr)
		Asset_ImportSprites("icons", "assets/bin/t6_sprites3", S65_LastImportPtr) //Carry on from above address
		...
		paletteSpr:
		Asset_ImportSpritePalette("icons")
